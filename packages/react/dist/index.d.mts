...
declare const ToastContainer: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Toast$1.ToastProps & react.RefAttributes<HTMLLIElement>>, {
    type?: "normal" | "success" | "error" | undefined;
}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
...
declare function Toast({ title, description, open, setOpen, ...props }: ToastProps): react_jsx_runtime.JSX.Element;
...
declare const theme: string & {
    ...
    colors: {
        ...
        ignite800: _stitches_react_types_theme.Token<"ignite800", string, "colors", "">;
        red500: _stitches_react_types_theme.Token<"red500", string, "colors", "">;
        red300: _stitches_react_types_theme.Token<"red300", string, "colors", "">;
    };
    fontSizes: {
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        ignite800?: string | number | boolean | undefined;
