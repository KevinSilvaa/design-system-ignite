...
var TooltipContent = styled(Tooltip.Content, {
  ...
  '&[data-state="delayed-open"][data-side="bottom"]': {
    animation: `${slideIn2} 200ms ease-in`
  },
...
function Tooltip2(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipUI.Provider, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipUI.Root, __spreadProps(__spreadValues({}, props), { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipUI.Trigger, { asChild: true, children }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipUI.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipContent, { sideOffset: 4, children: [
      content,
...
var ToastContainer = styled(Toast.Root, {
  ...
  '&[data-state="open"]': {
    animation: `${slideIn3} 0.3s ease-in`
  },
  '&[data-state="closed"]': {
...
function Toast2(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(ToastUI.Provider, { swipeDirection: "right", duration: 2e3, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(ToastContainer, __spreadProps(__spreadValues({ open }, props), { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToastTitle, { as: "h2", children: title }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToastDescription, { as: "span", children: description }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ToastCloseButton, { onClick: () => setOpen(!open), children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_phosphor_react3.X, { size: 20 }) })
    ] })),
